...
############################################################
range_w <- read.csv('Use_All_Sites_modelData_BioDiv_newdata_range.csv', row.names = 1)
allscalings <- read.csv('Use_All_Sites_modelData_BioDiv_transform_scaling.csv')
...
newdata <- list(bio01 = temps_sc, catch_areas = catch_areas_sc, human = humans_sc)
saveRDS(newdata, 'Use_All_Sites_modelData_BioDiv_newdata.RDS')
############################################################
####A01: prediction of full models
############################################################
allscalings <- read.csv('Use_All_Sites_modelData_BioDiv_transform_scaling.csv')
newdata <- readRDS('Use_All_Sites_modelData_BioDiv_newdata.RDS')
...
data_RS <- read.csv('../result/Res_02_SAR_based_Full_reshuffled_2025-06-13.csv')
data_DS <- read.csv('../result/Res_02_SAR_based_Full_downsampled_2025-06-13.csv')
